...
@ApplicationScoped
public class TopologyProducerFilter {
	...
	private final String OUTPUT_JOIN_FILTER = "output-join-filter";
	...
	public Topology getTopChartsJoinFilter() {
		...
		.to(OUTPUT_JOIN_FILTER, Produced.with(Serdes.Integer(), playbackStatusSerder));
		
		logger.info(" Output Join Filter SUCCESSFUL.... ");
